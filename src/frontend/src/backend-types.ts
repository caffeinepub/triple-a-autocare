// Re-export all app types — this file bridges the stub backend.ts
// with the real type definitions used throughout the app.
...
export interface backendInterface {
  ...
  updateBookingStatus(
    bookingId: string,
    newStatus: Variant_cancelled_pending_completed_confirmed,
  ): Promise<void>;
  submitRating(
    requestId: string,
    rating: bigint,
